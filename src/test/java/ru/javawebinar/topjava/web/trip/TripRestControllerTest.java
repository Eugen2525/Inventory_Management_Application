...
public class TripRestControllerTest extends AbstractControllerTest {

    public static final String REST_URL = TripRestController.REST_URL + '/';
    ...
    public void testCreate() throws Exception {
        Trip created = getCreated();
        ResultActions action = mockMvc.perform(post(REST_URL)
                .contentType(MediaType.APPLICATION_JSON)
                .content(JsonUtil.writeValue(created))
                .with(userHttpBasic(ADMIN)));

        Trip returned = MATCHER.fromJsonAction(action);
    ...
    public void testGetAll() throws Exception {
        mockMvc.perform(get(REST_URL).contentType(MediaType.APPLICATION_JSON)
                ...
                .andDo(print())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(MATCHER_WITH_EXCEED.contentListMatcher(TripUtil.getWithExceeded(USER_MEALS, USER.getCaloriesPerDay())));
    }
    ...
    public void testGetBetween() throws Exception {
        mockMvc.perform(get(REST_URL + "between?startDateTime=2015-05-30T07:00&endDateTime=2015-05-31T11:00:00")
                ...
                .andExpect(MATCHER_WITH_EXCEED.contentListMatcher(
                        TripUtil.createWithExceed(MEAL4, true),
                        TripUtil.createWithExceed(MEAL1, false)));
    }
    ...
    public void testFilterAll() throws Exception {
        mockMvc.perform(get(REST_URL + "filter?startDate=&endTime=")
                ...
                .andDo(print())
                .andExpect(MATCHER_WITH_EXCEED.contentListMatcher(
                        TripUtil.getWithExceeded(Arrays.asList(MEAL6, MEAL5, MEAL4, MEAL3, MEAL2, MEAL1), USER.getCaloriesPerDay())));
    }
}