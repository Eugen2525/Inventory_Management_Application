        ...
        <div class="shadow">
            ...
            <div class="view-box">
                <form:form modelAttribute="userTo" class="form-horizontal" method="post"
                    ...
                    <topjava:inputField label="Имя" name="name"/>
                    <topjava:inputField label="э-почта" name="email"/>
                    <topjava:inputField label="Пароль" name="password" inputType="password"/>
                    <topjava:inputField label="Внутренний номер" name="caloriesPerDay" inputType="number"/>
